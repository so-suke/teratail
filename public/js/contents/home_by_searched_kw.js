  ...
  methods: {
    ...
    _getQuestionsInit: function() {
			...
			if(this.paginator === null) {
				axios_url = '/teratail/public/ajax_q/get_questions_by_searched_kw';
			} else {
				axios_url = `/teratail/public/ajax_q/get_questions_by_searched_kw?page=${this.paginator.current_page}`;
			}
      axios.get(axios_url)
        .then(response => {
          // console.log(response.data)
